# Recovery Device Tree for Nokia 6.1 Plus

#### Created for Pitchblack Recovery Project 

The Nokia 6.1 Plus/Nokia X6 (codenamed "DRG") is a mid-range smartphone from Nokia.
